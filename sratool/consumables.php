...
$consumables  = $conn->query("SELECT * FROM consumables ORDER BY item_name ASC");
$total_items  = $conn->query("SELECT COUNT(*) as count FROM consumables")->fetch_assoc()['count'];
$out_of_stock = $conn->query("SELECT COUNT(*) as count FROM consumables WHERE quantity = 0")->fetch_assoc()['count'];
$in_stock     = $conn->query("SELECT COUNT(*) as count FROM consumables WHERE quantity > 0")->fetch_assoc()['count'];
...
<head>
    ...
    <title>Consumables - Tool Room Management System</title>
...
<div class="main-content">
    ...
    <div class="action-bar">
        <h2><i class="fas fa-box-open"></i> Consumables Inventory</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <button class="btn-action btn-edit" onclick="openEditModal(<?php echo $row['id']; ?>, '<?php echo htmlspecialchars($row['item_name'], ENT_QUOTES); ?>', <?php echo $row['quantity']; ?>, '<?php echo htmlspecialchars($row['unit'], ENT_QUOTES); ?>')">
    ...
    <div class="modal-content">
        ...
        <form id="adjustForm" method="POST">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label id="adjustItemName" style="font-size: 16px; color: #333;"></label>
                </div>
                <div class="form-group">
...
<script src="../sratool/js/consumables.js"></script>
</body>
</html>
