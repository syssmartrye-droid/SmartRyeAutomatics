...
$items        = $conn->query("SELECT * FROM e_fences ORDER BY item_name ASC");
$total_items  = $conn->query("SELECT COUNT(*) as count FROM e_fences")->fetch_assoc()['count'];
$out_of_stock = $conn->query("SELECT COUNT(*) as count FROM e_fences WHERE quantity = 0")->fetch_assoc()['count'];
$in_stock     = $conn->query("SELECT COUNT(*) as count FROM e_fences WHERE quantity > 0")->fetch_assoc()['count'];
...
<head>
    ...
    <title>E-Fences - Tool Room Management System</title>
...
<div class="main-content">
    ...
    <div class="action-bar">
        <h2><i class="fas fa-shield-alt"></i> E-Fences Inventory</h2>
    ...
    <div class="table-container">
        ...
        <?php else: ?>
            <div class="empty-state">
                <i class="fas fa-shield-alt"></i>
                <p>No e-fence items in inventory</p>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script src="../sratool/js/efence.js"></script>
